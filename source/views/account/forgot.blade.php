                ...
                <article id="articleForm" class="message is-dark">
                    ...
                    <div class="message-body has-text-left">
                        ...
                        <div class="field has-text-right">
                            <button id="buttonSubmit" class="button is-dark">Request Forgot Password Email</button>
                        </div>
                    </div>
                </article>
        ...
        $(document).ready(function() {
            ...
            $('#buttonSubmit').on('click', function() {
                ...
                if (
                    ...
                    $.ajax({
                        url: '{{ localAddress() }}/api/v1/account/forgot/' + inputEmail.val(),
                        method: 'GET',
                        parent: {
